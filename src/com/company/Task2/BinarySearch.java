...
public class BinarySearch<Type> {
    ...
    private int searchProcess(int start, int end) throws Exception {
        ...
        //Split array
        if (this.Data[middleIndex].toString().compareTo(this.SearchPattern.toString()) > 0)
            return searchProcess(start, middleIndex);
        else if (this.Data[middleIndex].toString().compareTo(this.SearchPattern.toString()) < 0)
